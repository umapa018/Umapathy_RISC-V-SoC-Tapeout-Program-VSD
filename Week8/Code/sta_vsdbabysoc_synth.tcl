...
set design_path "/data/OpenROAD-flow-scripts/flow/results/sky130hd/vsdbabysoc/base"
set sdc_path "/data/OpenROAD-flow-scripts/VSDBabySoC/OpenSTA/examples/BabySOC"
set output_path "/data/OpenROAD-flow-scripts/sta_output_week8/synth"
...
for {set i 1} {$i <= [array size list_of_lib_files]} {incr i} {
    ...
    read_verilog $design_path/1_synth.v
